...
extern int toggleOverlay;    /* toggle overlay on and off */
...
extern int aone;          /* Alpha-one */
extern int opaque;        /* Turn on/off opaque */
extern double alpha;      /* Alpha value */

/*  Textures  */
extern unsigned int textures[8]; /* holds our textures */
extern int currentTexture;       /* current texture */

/*  Objects  */
extern cube_s cubes[8]; /* cube objects */
